...
Complete or demonstrate Minimum Competency in [Linux](../04-linux/README.md), [Git](../05-git/README.md), and [AWS](../12-aws/README.md). These are mechanism prerequisites, not merely earlier module numbers.
