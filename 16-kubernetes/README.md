...
Complete or demonstrate Minimum Competency in [Containers](../15-containers/README.md) and [Networking](../07-networking/README.md). These are mechanism prerequisites, not merely earlier module numbers.
