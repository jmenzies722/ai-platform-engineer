...
This is Module 14 of 35. It follows [DevOps](../13-devops/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.
...
- the relationships among declarative infrastructure, state, dependency graphs, providers, modules, plans, drift, and safe lifecycle management;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [Containers](../15-containers/README.md).
