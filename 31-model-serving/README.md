...
Complete or demonstrate Minimum Competency in [LLM Engineering](../27-llm-engineering/README.md) and [AI Infrastructure](../30-ai-infrastructure/README.md). These are mechanism prerequisites, not merely earlier module numbers.
