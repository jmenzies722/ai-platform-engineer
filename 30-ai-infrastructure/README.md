...
Complete the Minimum Competency tier for [GPU Systems](../29-gpu-systems/README.md), or demonstrate the same capability with build and debugging evidence. Follow any additional prerequisites when this module’s lessons are published.
