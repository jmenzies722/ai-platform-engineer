...
This is Module 19 of 35. It follows [Observability](../18-observability/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.
...
- the relationships among service-level objectives, error budgets, toil reduction, capacity planning, incident response, and automation to govern reliability;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [Security](../20-security/README.md).
