...
This is Module 23 of 35. It follows [Developer Platforms](../22-developer-platforms/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.

### What do I need first?

Complete the Minimum Competency tier for [Developer Platforms](../22-developer-platforms/README.md), or demonstrate the same capability with build and debugging evidence. Follow any additional prerequisites when this module’s lessons are published.

### What will I be able to explain afterward?

- the everyday problems this domain solves, before using specialized vocabulary;
- the relationships among declarative APIs, reconciliation, controllers, state machines, work queues, idempotency, convergence, and multi-tenant policy;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [AI Foundations](../24-ai-foundations/README.md).
