...
Complete or demonstrate Minimum Competency in [Machine Learning and Deep Learning](../25-ml-deep-learning/README.md). These are mechanism prerequisites, not merely earlier module numbers.
