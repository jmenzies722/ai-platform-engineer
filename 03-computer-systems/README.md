...
This is Module 03 of 35. It follows [Python](../02-python/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.
...
- the relationships among representation, instruction execution, CPU caches, memory hierarchy, I/O, interrupts, concurrency, and performance;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [Linux](../04-linux/README.md).
