...
This is Module 12 of 35. It follows [Software Architecture](../11-software-architecture/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.
...
- the relationships among cloud identity, networking, compute, storage, databases, messaging, observability, and cost as interacting control and data planes;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [DevOps](../13-devops/README.md).
