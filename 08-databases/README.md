...
Complete or demonstrate Minimum Competency in [Python](../02-python/README.md) and [Networking](../07-networking/README.md). These are mechanism prerequisites, not merely earlier module numbers.
