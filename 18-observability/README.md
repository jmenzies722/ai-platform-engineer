...
This is Module 18 of 35. It follows [Distributed Systems](../17-distributed-systems/README.md) and provides foundations used by later modules. See the [Curriculum](../CURRICULUM.md) for the complete dependency path.
...
- the relationships among telemetry that supports questions rather than dashboards that merely display data;
...
This scaffold is orientation, not completion. If you are following the active path, return to [START-HERE.md](../START-HERE.md). To preview the dependency that follows this module, open [Site Reliability Engineering](../19-sre/README.md).
