...
| Continuous batching | How can an inference scheduler keep a changing set of sequences using each model iteration? | [AI Infrastructure](00-history/18-ai-infrastructure.md) | [KV Cache and Continuous Batching](31-model-serving/05-kv-cache-and-continuous-batching.md) |
...
| Effect reconciliation | How can durable intent be resolved against an external side effect after a timeout or crash? | [Agentic Engineering](00-history/20-agentic-engineering.md) | [Durable Execution and Effect Reconciliation](33-agentic-infrastructure/06-durable-execution-and-reconciliation.md) |
| Evaluation gate | What exact evidence must an artifact satisfy before promotion? | [AI Platform Engineering](00-history/19-ai-platform-engineering.md) | [Practical AI Platform Lab](32-ai-platform-engineering/10-practical-ai-platform-lab.md) |
| Feature store | How can training and inference share governed feature definitions with event-time and freshness contracts? | [AI Platform Engineering](00-history/19-ai-platform-engineering.md) | [Data and Feature Platform Contracts](32-ai-platform-engineering/04-data-and-feature-platform-contracts.md) |
...
| KV cache | What attention state can autoregressive decoding reuse, and what controls its memory cost? | [Transformers and LLMs](00-history/17-transformers-and-llms.md) | [KV Cache and Continuous Batching](31-model-serving/05-kv-cache-and-continuous-batching.md) |
...
| Lineage | Which immutable inputs, transformations, runs, evaluations, and deployments produced an artifact or result? | [AI Platform Engineering](00-history/19-ai-platform-engineering.md) | [Data and Feature Platform Contracts](32-ai-platform-engineering/04-data-and-feature-platform-contracts.md), [Training Platform Architecture](32-ai-platform-engineering/05-training-platform-architecture.md) |
...
| Prefix cache | When can a serving system safely reuse computation for an exact shared token prefix? | [Transformers and LLMs](00-history/17-transformers-and-llms.md) | [KV Cache and Continuous Batching](31-model-serving/05-kv-cache-and-continuous-batching.md) |
...
| Quota | Which enforced limit bounds a tenant’s admitted use, independently of budget and physical capacity? | [AI Platform Engineering](00-history/19-ai-platform-engineering.md) | [Tenancy, Governance, and Cost](32-ai-platform-engineering/02-tenancy-governance-and-cost.md) |
