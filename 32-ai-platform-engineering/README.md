...
Complete the Minimum Competency tier for [Model Serving](../31-model-serving/README.md), or demonstrate the same capability with build and debugging evidence. Follow any additional prerequisites when this module’s lessons are published.
